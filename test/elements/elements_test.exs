defmodule Bolt.Sips.Elements.Test do
  ...
  @success_with_stats [
    success: %{"fields" => []}, success: %{"stats" => %{"labels-added" => 1,
    "nodes-created" => 1, "properties-set" => 1}, "type" => "w"}
  ]

  # "EXPLAIN MATCH (n), (m) RETURN n, m"
  @explain [
    success: %{"fields" => []}, success: %{"notifications" =>
    ...
    "position" => %{"column" => 1, "line" => 1, "offset" => 0}, "severity" => "WARNING",
    "title" => "This query builds a cartesian product between disconnected patterns."}],
    "plan" => %{"args" => %{"EstimatedRows" => 3.24e4, "KeyNames" => "n, m",
    "planner" => "COST", "planner-impl" => "IDP", "runtime" => "INTERPRETED",
    "runtime-impl" => "INTERPRETED", "version" => "CYPHER 3.0"},
    "children" => [%{"args" => %{"EstimatedRows" => 3.24e4},
    "children" => [%{"args" => %{"EstimatedRows" => 180.0}, "children" => [],
    "identifiers" => ["n"], "operatorType" => "AllNodesScan"},
    %{"args" => %{"EstimatedRows" => 180.0}, "children" => [], "identifiers" => ["m"],
    "operatorType" => "AllNodesScan"}], "identifiers" => ["m", "n"], "operatorType" =>
    "CartesianProduct"}], "identifiers" => ["m", "n"], "operatorType" => "ProduceResults"},
    "type" => "r"}
  ]

  # "PROFILE CREATE (n) RETURN n"
  @profile [
    success: %{"fields" => ["n"]}, record: [[sig: 78, fields: [193, [], %{}]]],
    success: %{"profile" => %{"args" => %{"DbHits" => 0, "EstimatedRows" => 1.0,
    "KeyNames" => "n", "Rows" => 1, "planner" => "COST", "planner-impl" => "IDP",
    "runtime" => "INTERPRETED", "runtime-impl" => "INTERPRETED",
    "version" => "CYPHER 3.0"}, "children" => [%{"args" => %{"DbHits" => 2,
    "EstimatedRows" => 1.0, "Rows" => 1}, "children" => [], "dbHits" => 2,
    "identifiers" => ["n"], "operatorType" => "CreateNode", "rows" => 1}],
    "dbHits" => 0, "identifiers" => ["n"], "operatorType" => "ProduceResults",
     "rows" => 1}, "stats" => %{"nodes-created" => 1}, "type" => "rw"}
  ]

  # MERGE p=({name:'Alice'})-[:KNOWS]->({name:'Bob'}) RETURN p
  @path [
    success: %{"fields" => ["p"]},
    record: [[sig: 80, fields: [[[sig: 78, fields: [172, [], %{"name" => "Alice"}]],
      [sig: 78, fields: [182, [], %{"name" => "Bob"}]]],
      [[sig: 114, fields: [259, "KNOWS", %{}]]], [1, 1]]]],
    success: %{"type" => "rw"}
  ]
  ...
  @coalesce [
    ...
    record: [[sig: 78, fields: [432, ["Person"],
      %{"bolt_sips" => true, "name" => "Patrick Rothfuss"}]],
      "Patrick Rothfuss", "PATRICK ROTHFUSS", "n/a", %{"label" => "Person",
      "name" => "Patrick Rothfuss"}],
    record: [[sig: 78, fields: [433, ["Person"], %{"bolt_sips" => true,
      "name" => "Kote"}]], "Kote", "KOTE", "n/a", %{"label" => "Person", "name" => "Kote"}],
    record: [[sig: 78, fields: [434, ["Person"], %{"bolt_sips" => true, "name" => "Denna"}]],
      "Denna", "DENNA", "n/a", %{"label" => "Person", "name" => "Denna"}],
    success: %{"type" => "r"}]
  ...
  @complex_path [
    ...
    record: [[sig: 78, fields: [114, ["Database"], %{"name" => "Neo4j"}]],
     [sig: 78, fields: [119, ["Person", "Expert"], %{"name" => "Amanda"}]],
     [sig: 80,
      fields: [[[sig: 78, fields: [107, ["Person"], %{"name" => "You"}]],
        [sig: 78, fields: [108, ["Person"], %{"name" => "Anna"}]],
        [sig: 78, fields: [119, ["Person", "Expert"], %{"name" => "Amanda"}]]],
       [[sig: 114, fields: [282, "FRIEND", %{}]],
        [sig: 114, fields: [289, "FRIEND", %{}]]], [1, 1, 2, 2]]]],
    record: [[sig: 78, fields: [114, ["Database"], %{"name" => "Neo4j"}]],
     ...
     [sig: 80,
      fields: [[[sig: 78, fields: [107, ["Person"], %{"name" => "You"}]],
        ...
        [sig: 78, fields: [116, ["Person", "Expert"], %{"name" => "Amanda"}]]],
       [[sig: 114, fields: [282, "FRIEND", %{}]],
        [sig: 114, fields: [287, "FRIEND", %{}]]], [1, 1, 2, 2]]]],
    record: [[sig: 78, fields: [114, ["Database"], %{"name" => "Neo4j"}]],
     ...
     [sig: 80,
      fields: [[[sig: 78, fields: [107, ["Person"], %{"name" => "You"}]],
        ...
        [sig: 78, fields: [115, ["Person", "Expert"], %{"name" => "Amanda"}]]],
       [[sig: 114, fields: [282, "FRIEND", %{}]],
        [sig: 114, fields: [285, "FRIEND", %{}]]], [1, 1, 2, 2]]]],
    success: %{"type" => "r"}
  ]
  ...
  @movie_crew [
    ...
    record: ["You've Got Mail", ["Steve Zahn", "Dave Chappelle", "Meg Ryan", "Tom Hanks", "Parker Posey", "Greg Kinnear"]],
    record: ["Johnny Mnemonic", ["Ice-T", "Dina Meyer", "Takeshi Kitano", "Keanu Reeves"]],
    record: ["Stand By Me", ["Marshall Bell", "John Cusack", "Kiefer Sutherland", "Corey Feldman", "Jerry O'Connell", "River Phoenix", "Wil Wheaton"]],
  ...
  test "Movie and Crew" do
    ...
    assert cast  == ["Tom Hanks", "Kevin Bacon", "Ed Harris", "Bill Paxton",
                     "Gary Sinise"]
  end
  ...
  test "match (a)-[:HAS*]->(b) return collect(distinct b)" do
    ...
    assert row["collect(distinct b)"] == [
      %Bolt.Sips.Types.Node{id: 76, labels: ["Wheel"], properties: %{"bolt_sips" => true, "spokes" => 3}},
      %Bolt.Sips.Types.Node{id: 77, labels: ["Wheel"], properties: %{"bolt_sips" => true, "spokes" => 32}}
    ]
  end
  ...
  test "MATCH with coalesce" do
   ...
   assert row["p"] == %Bolt.Sips.Types.Node{id: 432, labels: ["Person"],
  ...
  test "success on EXPLAIN MATCH" do
    ...
    assert s.fields == []
    assert s.type == "r"
    assert s.plan["args"] == %{"EstimatedRows" => 3.24e4, "KeyNames" => "n, m", "planner" => "COST", "planner-impl" => "IDP", "runtime" => "INTERPRETED", "runtime-impl" => "INTERPRETED", "version" => "CYPHER 3.0"}
  end

  test "success" do
    {:ok, s} = Success.new(@success)
    assert %Success{fields: ["p", "r"], type: "r", records: [
      [[sig: 78, fields: [1, ["Person"], %{"born" => 1964, "name" => "Keanu Reeves"}]],
        [sig: 82, fields: [221, 1, 154, "ACTED_IN", %{"roles" => ["Julian Mercer"]}]]],
      [[sig: 78, fields: [1, ["Person"], %{"born" => 1964, "name" => "Keanu Reeves"}]],
        [sig: 82, fields: [132, 1, 100, "ACTED_IN", %{"roles" => ["Johnny Mnemonic"]}]]]]} == s

    assert ["p", "r"] == s.fields
    assert "r" == s.type
    assert length(s.records) == 2
    assert [:__struct__, :fields, :notifications, :plan,
            :profile, :records, :stats, :type] == Map.keys(s)
  end
  ...
  test "a record extraction" do
    ...
    assert record["p"] == %Node{id: 1, labels: ["Person"],
            properties: %{"born" => 1964, "name" => "Keanu Reeves"}}

    assert record["r"] == %Relationship{id: 221, start: 1, end: 154,
            properties: %{"roles" => ["Julian Mercer"]}, type: "ACTED_IN"}
