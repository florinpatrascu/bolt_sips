# benchmark the time it takes to open connections to a local neo4j server. Misc...
# 
# What I want:
# 
# - I want to measure the time it takes to open a connection and run a simple query
# - I want to demonstrate how saving and reusing a connection (where applicable) takes
# less time compared with a similar code where I'm creating a new connection for every query
# 
